...
export const metadata: Metadata = {
  ...
  description: "Experience authentic Italian cuisine with traditional recipes, fresh ingredients, and warm hospitality. Book your table at Bella Vista today.",
  keywords: "Italian restaurant, authentic pasta, wood-fired pizza, fine dining, reservations",
  openGraph: {
    title: "Bella Vista - Authentic Italian Restaurant",
    description: "Experience authentic Italian cuisine with traditional recipes, fresh ingredients, and warm hospitality.",
  ...
  twitter: {
    ...
    title: "Bella Vista - Authentic Italian Restaurant",
    description: "Experience authentic Italian cuisine with traditional recipes and warm hospitality.",
